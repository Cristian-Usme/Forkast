...
from app.repositories.recommendations_repo import fetch_recipes_dataset, fetch_user_profile
...
def generate_recommendations(user_id: str, top_n: int = 6) -> list[dict]:
